  ...
  function d(e) {
    if (0 < e.touches.length)
      for (let t = 0; t < e.touches.length; t++)
        r(e.touches[t].clientX, e.touches[t].clientY, s[Math.floor(Math.random() * s.length)])
  }
  function r(t, e, i) {
    a.push(new u(t, e, i))
  }
  ...
  ;(l = document.createElement('canvas')),
    ...
    t.addEventListener('mousemove', function (t) {
      window.requestAnimationFrame(() => {
        ;(o.x = t.clientX),
          (o.y = t.clientY),
          1.5 < Math.hypot(o.x - h.x, o.y - h.y) &&
            (r(o.x, o.y, s[Math.floor(Math.random() * e.length)]), (h.x = o.x), (h.y = o.y))
      })
    }),
    t.addEventListener('touchmove', d, { passive: !0 }),
    t.addEventListener('touchstart', d, { passive: !0 }),
    window.addEventListener('resize', function (t) {
      ;(i = window.innerWidth), (n = window.innerHeight), (l.width = i), (l.height = n)
    }),
    (function t() {
      c.clearRect(0, 0, i, n)
      for (let t = 0; t < a.length; t++) a[t].update(c)
      for (let t = a.length - 1; 0 <= t; t--) a[t].lifeSpan < 0 && a.splice(t, 1)
